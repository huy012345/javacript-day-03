...
async function downloadAll() {
    ...
    downloadAll();
    // const URL_DATA="https://tiki.vn/api/personalish/v1/blocks/listings?limit=40&include=adv...-tinh-bo"
// const MY_CART = JSON.parse(localStorage.getItem("MY_CART")) || []
// console.log(MY_CART);
// const fetchDATE = ()=>{
//     let loadingEL=document.getElementById("loading-tiki")
//     loadingDL.innerHTML= "Đang loading sản phẩm từ tiki.."
